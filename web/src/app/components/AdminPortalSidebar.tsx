...
export default function AdminPortalSidebar({ isOpen, onClose }: AdminPortalSidebarProps) {
        ...
        {userInfo && (
          ...
          `}>
            <div className={`
              ...
              rounded-full bg-red-600 flex items-center justify-center flex-shrink-0 mx-auto mb-3
            `}>
              <Icon icon={faUserShield} className="text-white" size={collapsed ? 'lg' : '2x'} />
            </div>
            {!collapsed && (
              ...
              return (
                <li key={index}>
                  ...
                  >
                    <Icon
                      icon={item.icon}
                      className={active ? 'text-red-600' : 'text-gray-500'}
                      size="sm"
                    />
                    {!collapsed && (
