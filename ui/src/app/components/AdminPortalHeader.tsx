...
import Icon, { faBars, faTimes, faBell, faRightFromBracket, faUserShield, faUser, faSearch, faCog, faChevronDown, faNewspaper, faAward, faFileAlt, faArrowRight } from './Icon';
...
export default function AdminPortalHeader({ 
  ...
  const notifications = [
    { id: 1, type: 'application', title: '12 new student applications', time: '2 hours ago', read: false, icon: faFileAlt },
    { id: 2, type: 'system', title: 'System maintenance scheduled', time: '5 hours ago', read: false, icon: faAward },
    { id: 3, type: 'alert', title: 'High enrollment in MBA program', time: '1 day ago', read: true, icon: faNewspaper },
    { id: 4, type: 'update', title: 'Course catalog updated', time: '2 days ago', read: true, icon: faNewspaper },
  ];
